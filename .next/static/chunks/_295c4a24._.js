...
function TestPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$0$2d$canary$2e$47_react_818dc233c00a743137786d541e7239b1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TestPage.useEffect": ()=>{
            const fetchMessage = {
                "TestPage.useEffect.fetchMessage": async ()=>{
                    try {
                        setLoading(true);
                        setError('');
                        const { data, error: queryError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('test_connection').select('message').single();
                        if (queryError) {
            ...
            }["TestPage.useEffect.fetchMessage"];
            fetchMessage();
        }
    }["TestPage.useEffect"], []);
...
_s(TestPage, "2aI/HcO0dwxmK5rOx7profnm3Ns=");
_c = TestPage;
var _c;
...
//# sourceMappingURL=_295c4a24._.js.map