...
"[project]/app/(dashboard)/live-demo.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LiveDemo() {
    ...
    const fetchData = async ()=>{
        try {
            setLoading(true);
            setError('');
            const { data, error: queryError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('test_connection').select('message, created_at').order('created_at', {
                ascending: false
            }).limit(1).single();
            if (queryError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89a6ebda._.js.map